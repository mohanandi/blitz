                ...
                <div class="page-title-heading">
                    ...
                    <div>PT. Blitzindo Utama
                        <nav class="page-title-subheading" aria-label="breadcrumb">
                            <ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="javascript:void(0);">Data Voucher</a></li>
								<li class="breadcrumb-item"><a href="javascript:void(0);">Input Voucher VISA</a></li>
                                <li class="active breadcrumb-item" aria-current="page">Buat Voucher Visa Other</li>
                            </ol>
                        </nav>
                    </div>
                </div>
				...
				<div class="d-inline-block" >
						...
						<div class="input-group">
							  ...
							  <div class="input-group-append">
							     <input name="jumlah" id="jum" type="text" class="form-control-sm form-control" placeholder="Nama Client">
