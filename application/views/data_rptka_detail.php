<div class="app-main__outer">
    <div class="app-main__inner">
                ...
                <div class="page-title-heading">
                    ...
                    <div>PT. Blitzindo Utama
                        <nav class="page-title-subheading" aria-label="breadcrumb">
                            <ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="javascript:void(0);">Data RPTKA</a></li>
		...
		<div class="row">
                            <div class="col-lg-6">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Manajemen Kuota</h5>
							...
							<div class="col-lg-6">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Total Kuota</h5>
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover text-center">
                                            <tbody>
											<tr>
                                                <th>Total</th>
